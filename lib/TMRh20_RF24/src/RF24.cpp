...
void RF24::printDetails(void)
{
  ...
  Serial.print(String("Data Rate\t = ") + String(rf24_datarate_e_str_P[getDataRate()]) + "\r\n");
  Serial.print(String("Model\t\t = ") + String(rf24_model_e_str_P[isPVariant()]) + "\r\n");
  Serial.print(String("CRC Length\t = ") + String(rf24_crclength_e_str_P[getCRCLength()]) + "\r\n");
  Serial.print(String("PA Power\t = ") + String(rf24_pa_dbm_e_str_P[getPALevel()]) + "\r\n");
}
...
void RF24::whatHappened(volatile bool& tx_ok, volatile bool& tx_fail, volatile bool& rx_ready)
{
